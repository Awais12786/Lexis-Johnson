      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 relative z-10">
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">arrow_forward</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">MOVE</h3>
          ...
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">pause</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">PAUSE</h3>
          ...
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">sync</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">REPOSITION</h3>
          ...
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">campaign</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">PROMOTE</h3>
          ...
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">drag_handle</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">WAIT</h3>
          ...
          <div className="glass-card p-6 rounded-lg text-center shadow-[0_0_15px_rgba(255,225,109,0.05)]">
            <span className="material-symbols-outlined text-[48px] text-secondary-fixed mb-3">front_hand</span>
            <h3 className="font-display-lg text-xl text-secondary-fixed mb-2">STOP FORCING</h3>
