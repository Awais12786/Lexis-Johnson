      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 mb-16">
          ...
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">sell</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Offer</h3>
          ...
          {/* Card 2 */}
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">filter_alt</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Funnel</h3>
          ...
          {/* Card 3 */}
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">my_location</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Niche</h3>
          ...
          {/* Card 4 */}
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">hub</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Platform</h3>
          ...
          {/* Card 5 */}
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">handshake</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Coach</h3>
          ...
          {/* Card 6 */}
          <div className="glass-card p-8 rounded-lg flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-[64px] text-secondary-fixed mb-4">payments</span>
            <h3 className="font-display-lg text-2xl text-secondary-fixed mb-4">New Price</h3>
        ...
        <div className="text-center">
          <p className="font-display-lg text-3xl font-bold italic text-secondary-fixed">
